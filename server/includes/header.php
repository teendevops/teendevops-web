    ...
    <nav>
        <div id="custom-bootstrap-menu" class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header"><a class="navbar-brand" href="\" style="font-family: monospace !important"><?php echo strtolower(SITE_TITLE); ?></a>
                ...
                <div class="collapse navbar-collapse navbar-menubuilder">
                    <ul class="nav navbar-nav navbar-left">
                        <?php
                            if(isSignedIn()) {
                                echo "
                                    <li><a href=\"\profile/" . $_SESSION['id'] . "\">" . SHORT_USER_PROFILE . "</a></li>
                                    <li><a href=\"\settings\">" . SHORT_USER_SETTINGS . "</a></li>
                                    <li><a href=\"\logout\">" . SHORT_USER_LOGOUT . "</a></li>
                                ";
                            } else {
                                if(CAN_LOGIN)
